    ...
    internal class Program
    {
            ...
            out int healthPointWitcherAfterCombat)
        {
            ...
            if (healthPointWitcher >= 30)
            {
                ...
                damageWitcher = CountCricitalStrike(damageWitcher, cricitalStrikeDamageWticher);
            ...
            {
                healthPointWitcherAfterCombat = WitcherHealMySelf(healPotion, healthPointWitcherAfterCombat);
            }
        ...
        static int WitcherHealMySelf(int healPotion, int healthPointWitcherAfterCombat)
        {
        ...
        static int CountCricitalStrike(int damageWitcher, int cricitalStrikeDamageWticher)
        {
